...
const Session = (props) => {
  ...
  return (
    <Grid container item direction="row" justifyContent='center'>
      <Grid container item justifyContent="center" sx={{marginBottom:'20px'}}>
        <Typography variant='h2' color='white'>Session</Typography>
      </Grid>
      <Grid item container direction='column' xs={5}>
      {
        sessionItems.map((item, key)=>(
            <Card sx={{marginBottom:'20px'}}>
              <CardHeader component='h1' title={item.header}>
              </CardHeader>
              <CardContent>
